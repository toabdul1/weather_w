...
public class WeatherDetailActivity extends BaseActivity {
    ...
    TextView tv_cityname, tv_temp, tv_climate_description,tv_temp_max,tv_temp_min;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_temp_max = findViewById(R.id.tv_tmp_max);
        tv_temp_min = findViewById(R.id.tv_tmp_min);
    ...
    private void generateUI(WeatherModel weatherModel) {
        ...
        tv_temp_max.setText("max: "+weatherModel.getMain().getTemp_max());
        tv_temp_min.setText("min: "+weatherModel.getMain().getTemp_min());
